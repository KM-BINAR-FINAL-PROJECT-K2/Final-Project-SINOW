...
router.post("/", authenticate, checkRole("admin"), uploader.single("video"), Module.createModule);
router.get("/", Module.getAllModule);
router.get("/:id", Module.getModuleById);
router.put("/:id", authenticate, checkRole("admin"), uploader.single("video"), Module.updateModule);
